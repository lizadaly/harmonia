...
export const lillian1 = () => (
  <div>
    ...
    <p style={{textIndent: 0, textAlign: "left", paddingRight: "5em"}}>
      Yours, <br/>
      Lillian (Cadwell) Noyes
    </p>
    <p style={{textIndent: 0}}>
      P.S.  I hope that you are able to come and see my daughter some time. She is so beautiful, and it would
      gladden my heart to show you the woman that I have become.
